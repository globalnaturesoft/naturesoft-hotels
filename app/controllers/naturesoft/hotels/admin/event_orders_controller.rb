module Naturesoft
  module Hotels
    module Admin
      class EventOrdersController < Naturesoft::Admin::AdminController
        before_action :set_event_order, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
            
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Booking Hotel", naturesoft_hotels.admin_event_orders_path
          add_breadcrumb "Event Booking", naturesoft_hotels.admin_event_orders_path
        end
