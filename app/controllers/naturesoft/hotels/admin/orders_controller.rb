module Naturesoft
  module Hotels
    module Admin
      class OrdersController < Naturesoft::Admin::AdminController
        before_action :set_order, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
            
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Hotel", naturesoft_hotels.admin_orders_path
          add_breadcrumb "Booking", naturesoft_hotels.admin_orders_path
        end
