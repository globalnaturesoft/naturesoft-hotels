module Naturesoft
  module Hotels
    module Admin
      class RoomsController < Naturesoft::Admin::AdminController
        ...
        def default_breadcrumb
          ...
          add_breadcrumb "Rooms", naturesoft_hotels.admin_hotels_path
        end
        ...
        def create
          ...
          if @room.save
            redirect_to naturesoft_hotels.edit_admin_room_path(@room.id), notice: 'Room was successfully created.'
          else
            render :new
          end
        end
