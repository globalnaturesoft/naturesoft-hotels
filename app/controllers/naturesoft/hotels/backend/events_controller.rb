module Naturesoft
  module Hotels
    module Backend
      class EventsController < Naturesoft::Backend::BackendController
        before_action :set_event, only: [:show, :edit, :update, :destroy, :enable, :disable]
        before_action :default_breadcrumb
        
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Event", naturesoft_hotels.backend_events_path
        end
        ...
        def create
          ...
          if @event.save
            redirect_to naturesoft_hotels.edit_backend_event_path(@event.id), notice: 'Event was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @event.update(event_params)
            redirect_to naturesoft_hotels.edit_backend_event_path(@event.id), notice: 'Event was successfully updated.'
          else
            render :edit
          end
        end
