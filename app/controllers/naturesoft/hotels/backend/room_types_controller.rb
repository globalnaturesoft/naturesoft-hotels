module Naturesoft
  module Hotels
    module Backend
      class RoomTypesController < Naturesoft::Backend::BackendController
        before_action :set_room_type, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
        
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Hotel", naturesoft_hotels.backend_room_types_path
          add_breadcrumb "Room Types", naturesoft_hotels.backend_room_types_path
        end
        ...
        def create
          ...
          if @room_type.save
            redirect_to naturesoft_hotels.edit_backend_room_type_path(@room_type.id), notice: 'Room type was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @room_type.update(room_type_params)
            redirect_to naturesoft_hotels.edit_backend_room_type_path(@room_type.id), notice: 'Room type was successfully updated.'
          else
            render :edit
          end
        end
