    ...
    module Backend
      class LabelsController < Naturesoft::Backend::BackendController
        ...
        def default_breadcrumb
          add_breadcrumb "Hotel", naturesoft_hotels.backend_labels_path
          add_breadcrumb "Label", naturesoft_hotels.backend_labels_path
        end
        ...
        def create
          ...
          if @label.save
            redirect_to naturesoft_hotels.edit_backend_label_path(@label.id), notice: 'Label was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @label.update(label_params)
            redirect_to naturesoft_hotels.edit_backend_label_path(@label.id), notice: 'Label was successfully updated.'
          else
            render :edit
          end
        end
