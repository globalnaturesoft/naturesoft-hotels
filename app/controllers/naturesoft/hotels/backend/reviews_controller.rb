module Naturesoft
  module Hotels
    module Backend
      class ReviewsController < Naturesoft::Backend::BackendController
        before_action :set_review, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
            
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Hotel", naturesoft_hotels.backend_reviews_path
          add_breadcrumb "Reviews", naturesoft_hotels.backend_reviews_path
        end
        ...
        #
        #  if @review.save
        #    redirect_to naturesoft_hotels.edit_backend_review_path(@review.id), notice: 'Review was successfully created.'
        #  else
        #    render :new
        #  end
        #end
        ...
        #    redirect_to naturesoft_hotels.edit_backend_review_path(@review.id), notice: 'Review was successfully updated.'
        #  else
        #    render :edit
        #  end
        #end
